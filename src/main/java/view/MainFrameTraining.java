...
//        }
 ...
 //
    ...
    public JPanel panelForGymCreate(Gymnastic gym){
        ...
        panelForThisGym.add(new JTextArea(gym.getName()), BorderLayout.NORTH);

        JPanel tablePanel = new JPanel();
        tablePanel.add(new JTextArea(gym.getName()));
        tablePanel.add(new JTable(2,2));

        panelForThisGym.add(tablePanel, BorderLayout.LINE_START);
